...
%   Author:         Dongwei Bai, dbai@purdue.edu
%   Team ID:        003-10
%  	Contributor:    Dongwei Bai, dbai@purdue [repeat for each]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%% ____________________
%% INITIALIZATION
data = csvread('Data_CCPP_measurements.csv',1,0);
Ambient_temperature = data(:,1);
...
Net_Hourly_Electrial_Output_Ambient_temperature_fit = polyval(P1,Ambient_temperature);
Net_Hourly_Electrial_Output_Ambient_Atmospheric_Pressure_fit = polyval(P2,Ambient_Atmospheric_Pressure);
Net_Hourly_Electrial_Output_Relative_Humidty_fit = polyval(P3,Relative_Humidty);
Net_Hourly_Electrial_Output_Exhaust_Vacuum_Pressure_fit = polyval(P4,Exhaust_Vacuum_Pressure);
